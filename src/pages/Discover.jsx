  ...
  const translateHeroDescription = async (targetLang) => {
    ...
    try {
      try {
        ...
        const transText = localTranslator.translateSentence(activeHero.description, 'advanced');
              ...
              {books.map(b => (
                <div key={b.id} className="flex flex-col">
                  <BookCard 
                     ...
                     onPlayTrailer={setActiveAudioObj}
