...
import { X, Server, Zap, BrainCircuit, Globe, Key, Volume2, ArrowDownToLine, ArrowRightToLine, Wand2, Moon, ShieldX, Copy, GaugeCircle, Pin, PinOff, Settings, History, Trash2, ShieldAlert } from 'lucide-react';

export default function TranslationSettingsModal({ isOpen, onClose, onToolAction, isAutoTranslate, pinnedTools, onTogglePin, history = [], onNavigate }) {
